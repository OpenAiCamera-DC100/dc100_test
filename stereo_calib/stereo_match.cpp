...
int main(int argc, char** argv)
{
    ...
    cv::CommandLineParser parser(argc, argv,
        "{@arg1||}{@arg2||}{help h||}{algorithm|sgbm|}{max-disparity|256|}{blocksize|21|}{no-display||}{color|0|}{scale|1|}{i|intrinsics.yml|}{e|extrinsics.yml|}{o||}{p|point.txt|}");
    if(parser.has("help"))
    {
        print_help(argv);
        return 0;
